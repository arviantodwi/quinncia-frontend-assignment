...
export const MODAL_CONTENT_TYPE = 'feature/modal/content/type';

export const PHOTOS_PUSH = 'feature/photos/push';
export const PHOTOS_ACTIVE_PHOTO = 'feature/photos/active';
